...
import { addLike, deletePost, removeLike } from '../../actions/post.action';
            ...
            <div>
                ...
                </p>
                {
                    showActions ? <Fragment>
                        ...
                        {
                            !auth.loading && user === auth.user._id && (<button type="button" onClick={(e) => deletePost(_id)} className="btn btn-danger"><i className="fas fa-times"></i></button>)
                        }
                    </Fragment> : ''
                }
